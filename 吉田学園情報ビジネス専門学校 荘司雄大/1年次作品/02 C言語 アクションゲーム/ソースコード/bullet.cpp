...
void UpdateBullet(void)
{
	...
	for(nCntBullet = 0; nCntBullet < MAX_BULLET; nCntBullet++)
	{
		if (g_aBullet[nCntBullet].bUse == true)//弾が使用される
		{
			...
			//頂点座標の設定
			pVtx[0].pos = D3DXVECTOR3(g_aBullet[nCntBullet].pos.x, g_aBullet[nCntBullet].pos.y, g_aBullet[nCntBullet].pos.z);
			pVtx[1].pos = D3DXVECTOR3(g_aBullet[nCntBullet].pos.x + (g_aBullet[nCntBullet].fWidth), g_aBullet[nCntBullet].pos.y, g_aBullet[nCntBullet].pos.z);
			pVtx[2].pos = D3DXVECTOR3(g_aBullet[nCntBullet].pos.x, g_aBullet[nCntBullet].pos.y + g_aBullet[nCntBullet].fHeight, g_aBullet[nCntBullet].pos.z);
			...
			if (g_aBullet[nCntBullet].type == BULLETTYPE_PLAYER)
			{
				for (nCntEnemy = 0; nCntEnemy < MAX_ENEMY; nCntEnemy++, pEnemy++)
				{
					if (pEnemy->bUse == true)
					{
						if (g_aBullet[nCntBullet].pos.x > pEnemy->pos.x - 25
							&& g_aBullet[nCntBullet].pos.x < pEnemy->pos.x + 25
			...
			else if (g_aBullet[nCntBullet].type == BULLETTYPE_ENEMY)
			{
				...
				if (pPlayer->bUse == true)
				{
					if (g_aBullet[nCntBullet].pos.x > pPlayer->pos.x - 10
						...
						&& g_aBullet[nCntBullet].pos.y > pPlayer->pos.y - 25
						&& g_aBullet[nCntBullet].pos.y < pPlayer->pos.y + 25)
					{
						HitPlayer(1);
						g_aBullet[nCntBullet].bUse = false;
