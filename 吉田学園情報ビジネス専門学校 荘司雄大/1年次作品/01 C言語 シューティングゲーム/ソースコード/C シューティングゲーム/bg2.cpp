...
void UpdateBG2(void)
{
	...
	pVtx[1].tex = D3DXVECTOR2(1.0f+ (g_nCntAnim * BG_SPEED), 0.0f );
	pVtx[2].tex = D3DXVECTOR2(0.0f+ (g_nCntAnim * BG_SPEED),1.0f );
	pVtx[3].tex = D3DXVECTOR2(1.0f+ (g_nCntAnim * BG_SPEED), 1.0f );
