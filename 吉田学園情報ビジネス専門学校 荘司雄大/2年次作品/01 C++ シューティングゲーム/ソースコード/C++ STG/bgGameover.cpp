...
//静的メンバ変数
CRenderer *m_pBgGameOverRenderer = NULL;
LPDIRECT3DTEXTURE9 CBgGameover::m_apTexture[MAX_BG] = {};

//=============================================================================
// コンストラクタ
//=============================================================================
CBgGameover::CBgGameover() : CScene(0)
{
...
HRESULT CBgGameover::Load(void)
{
	...
	// テクスチャの生成
	D3DXCreateTextureFromFile(pDevice, GAMEOVER_TEXTURE0, &m_apTexture[0]);
	D3DXCreateTextureFromFile(pDevice, GAMEOVER_TEXTURE1, &m_apTexture[1]);
	D3DXCreateTextureFromFile(pDevice, GAMEOVER_TEXTURE2, &m_apTexture[2]);
...
// クリエイト
//=============================================================================
CBgGameover *CBgGameover::Create(void)
{
	CBgGameover *pBg = NULL;
	if (pBg == NULL)
	{
		// 動的確保
		pBg = new CBgGameover;
